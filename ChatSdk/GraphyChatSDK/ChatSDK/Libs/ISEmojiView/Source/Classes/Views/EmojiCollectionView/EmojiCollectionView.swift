...
internal protocol EmojiCollectionViewDelegate: AnyObject {
    ...
    func emojiViewDidSelectEmoji(emojiView: EmojiCollectionView, emoji: Emojis, selectedEmoji: String)
...
internal class EmojiCollectionView: UIView {
    ...
    internal func updateRecentsEmojis(_ emojis: [Emojis]) {
...
extension EmojiCollectionView {
    ...
    private func dismissPopView(_ usePopViewEmoji: Bool) {
        ...
        if !currentEmoji.isEmpty && usePopViewEmoji {
            self.delegate?.emojiViewDidSelectEmoji(emojiView: self, emoji: Emojis(emojis: emojiPopView.emojiArray), selectedEmoji: currentEmoji)
        }
