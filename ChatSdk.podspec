#
#  Be sure to run `pod spec lint ChatSdk.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ChatSdk"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ChatSdk."
  ...
  spec.author             = { "Sudhanshu Dwivedi" => "sudhanshu004@gmail.com" }
  # Or just: spec.author    = "Sudhanshu Dwivedi"
  # spec.authors            = { "Sudhanshu Dwivedi" => "sudhanshu004@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Sudhanshu Dwivedi"
